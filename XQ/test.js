...
var erjimenu = [
    ...
    {
        title: getMyVar('path') == '2' ? '““””<b><span style="color: #FF0000">线路三</span></b>' : '““””<b><span style="color: #1aad19">线路三</span></b>',
        url: $("#noLoading#").lazyRule(() => {
            if (getMyVar('path') == '2') {
                putMyVar('path', '0');
            } else {
    ...
    {
        title: getMyVar('path') == '3' ? '““””<b><span style="color: #FF0000">线路四</span></b>' : '““””<b><span style="color: #1aad19">线路四</span></b>',
        url: $("#noLoading#").lazyRule(() => {
            if (getMyVar('path') == '3') {
                putMyVar('path', '0');
            } else {
    ...
    {
        title: getMyVar('path') == '4' ? '““””<b><span style="color: #FF0000">线路五</span></b>' : '““””<b><span style="color: #1aad19">线路五</span></b>',
        url: $("#noLoading#").lazyRule(() => {
            if (getMyVar('path') == '4') {
                putMyVar('path', '0');
            } else {
